...
public:
    ...
    void searchAllByName(const std::string& searchName, std::vector<Student>& matchingStudents);
    void searchStudentsInAtLeastNUCs(const int n, std::set<Student>& matchingStudents);
    void searchStudentsInClass(const std::string& classCode, std::set<Student>& studentsOfTheClass);
};
