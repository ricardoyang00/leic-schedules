...
public:
    ...
    bool checkIfBalanceBetweenClassesDisturbed(const Global& globalCopy, map<string, int> classStudentsCount, const string& oldClassCode, const string& newClassCode);
